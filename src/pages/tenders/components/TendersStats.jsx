...
const TendersStats = ({ stats }) => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white rounded-xl shadow-lg p-5 border border-emerald-100 hover:shadow-xl transition-all">
          <div className="flex items-center justify-between">
            ...
            >
              <path
                fill="#10B981" // emerald-500 as "live" color
                d="M12 14a2 2 0 1 0 0-4a2 2 0 0 0 0 4"
              />
              <path
                fill="#10B981"
        ...
        <div className="bg-white rounded-xl shadow-lg p-5 border border-amber-100 hover:shadow-xl transition-all">
          <div className="flex items-center justify-between">
            <div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-5 border border-gray-100 hover:shadow-xl transition-all">
          <div className="flex items-center justify-between">
            <div>
